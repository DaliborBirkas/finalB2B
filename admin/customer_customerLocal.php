...
<head>
    ...
    <title>Admin - kupci i podkupci</title>
                ...
                if ($query->rowCount() > 0) : ?>
                    <?php foreach ($results as $result) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="show_customerOrders.php?id_customer=<?php echo $result->id_customer; ?>" class="btn btn-success me-3">Vidi narudžbe</a>
                                <a href="show_customerLocals.php?id_customer=<?php echo $result->id_customer; ?>" class="btn btn-info me-3">Vidi podkupce</a>
                                <a href="customer_customerLocal.php?delete=<?php echo $result->id_customer; ?>" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                <?php endif; ?>
