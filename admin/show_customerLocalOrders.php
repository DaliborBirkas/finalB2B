...
<body>
    ...
    <div class="container">
        ...
        $sql = "SELECT cl.name, cl.lastname 
            FROM orders o
            INNER JOIN customer c ON o.id_customer = c.id_customer
            INNER JOIN customer_local cl ON c.id_customer = cl.id_customer
        ...
        <div class="row justify-content-center">
            ...
            if ($query->rowCount() > 0) : ?>
                <?php foreach ($results as $result) { ?>
                    <h1 class="m-3 text-center text-info">Narudžbe kupca</h1>
                    <?php break ?>
                <?php } ?>
            <?php endif; ?>
                ...
                if ($query->rowCount() > 0) : ?>
                    <?php foreach ($results as $result) { ?>
                        <tr>
                            ...
                            <!--</td>-->
                            <td>
                                <a href="show_customerLocals.php?id_customer=<?php echo $result->id_customer; ?>" class="btn btn-danger me-3">Back</a>
                            </td>
                        </tr>
