...
<body>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            if ($query->rowCount() > 0) : ?>
                <?php foreach ($results as $result) { ?>
                    <h1 class="m-3 text-center text-info">Sve narudžbe</h1>
                    <?php break ?>
                <?php } ?>
            <?php endif; ?>
		<div class="table-responsive">
                ...
                if ($query->rowCount() > 0) : ?>
                    <?php foreach ($results as $result) { ?>
                        <tr>
                            ...
                            <!--</td>-->
                            <td>
                                <a href="see_order.php?id_order=<?php echo $result->id_order ?>" class="btn btn-info me-3">Vidi narudžbu</a>
                            </td>
                        </tr>
                    <?php } ?>
                <?php endif; ?>
            ...
            <!--        Tabela za narudžbe koje nisu isporučene             -->
            <?php


            if ($query->rowCount() > 0) : ?>
                <?php foreach ($results as $result) { ?>
                    <h1 class="m-3 text-center text-info">Neisporučene narudžbe</h1>
                    <?php break ?>
                <?php } ?>
            <?php endif; ?>
                ...
                if ($query->rowCount() > 0) : ?>
                    <?php foreach ($results as $result) { ?>
                        <tr>
                            ...
                            <!--</td>-->
                            <td>
                                <a href="see_order.php?id_order=<?php echo $result->id_order ?>" class="btn btn-warning me-3">Vidi narudžbu</a>
                                <a href="generate_facture.php?id_order=<?php echo $result->id_order ?>" class="btn btn-info me-3">Generiši predračun</a>
                                <a href="change_is_sent.php?id_order=<?php echo $result->id_order ?>" class="btn btn-success me-3">Poslato</a>
                            </td>
                        </tr>
                    <?php } ?>
                <?php endif; ?>
